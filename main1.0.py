...
steam = Steam("1798AFCA8CD6AD3534E2BF1D76A37710")
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                print("ошибка №3 записи в словарь")
        except:
            print('ошибка №2 копирования')
    except:
        print('ошибка 1')
...
idlist = ttk.Combobox(values=list(set(AccInFolder.keys()) - set(list(Id.keys()))), state="readonly") #сделать обновление списка после ввода
